...
## Code review (core task) in a Github Pull Request
...
8. Work through the Vulnerability Checklist below against the code.
   - Check the Vulnerability Glossary at the bottom of this file if you are unsure
   -  If it is present, leave a comment on the relevant line. In each comment, reference the checklist number and
...
9. If it is not present, be ready to explain why you ruled it out — not
